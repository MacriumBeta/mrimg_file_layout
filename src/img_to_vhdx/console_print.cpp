...
void printHelp() {
	...
	std::wcout << L"\timg_to_vhdx.exe c:\\backup.mrimg -p mypassword -d 1 -o C:\\output\n";
	std::wcout << L"\timg_to_vhdx.exe c:\\backup.mrimg -p mypassword -d 1\n";
	std::wcout << L"\timg_to_vhdx.exe c:\\backup.mrimg -p mypassword\n";
	std::wcout << L"\timg_to_vhdx.exe c:\\backup.mrimg\n";
	std::wcout << L"\timg_to_vhdx.exe c:\\backup.mrimg describe\n";
	std::wcout << L"\timg_to_vhdx.exe c:\\backup.mrimg json\n";
